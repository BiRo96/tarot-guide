            ...
            <div className="mt-4 p-2">
                ...
                <ul className="border-2 border-black">
                    <li className="border-b border-black py-3 bg-slate-400">
                        ...
                        <div className="bg-slate-800 text-white">({__("I took the original Rider-Waite tarot deck images from here")})</div>
                    </li>
                    <li className="border-b border-black py-3 bg-slate-400">
                        <div className="bg-slate-500"><Link to="https://chatgpt.com/" className="text-blue-300">ChatGPT 4.0 / 3.5</Link></div>
                        <div className="bg-slate-800 text-white">({__("It made the card datas and meanings summarized with keywords")})</div>
                    </li>
                    <li className="border-b border-black py-3 bg-slate-400">
